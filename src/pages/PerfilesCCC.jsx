  ...
  return (
    <div className='fullContainer containerProfiles'>
      <div className='directivo'>
        <Carrusel images={BACKGROUND_IMAGES_DIRECTIVO} currentImageIndex={indexDirectivo} />
      </div>
      ...
      <div className='docente'>
        <Carrusel images={BACKGROUND_IMAGES_DOCENTE} currentImageIndex={indexDocente} />
      </div>
      <div className='container containerProfiles'>
      ...
      <div className='estudiante'>
        <Carrusel images={BACKGROUND_IMAGES_ESTUDIANTE} currentImageIndex={indexEstudiante} />
      </div>
      <div className='container containerProfiles'>
      ...
      <div className='egresado'>
        <Carrusel images={BACKGROUND_IMAGES_EGRESADO} currentImageIndex={indexEgresado} />
      </div>
      <div className='container containerProfiles'>
