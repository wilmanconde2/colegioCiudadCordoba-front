  ...
  return (
    <div className='fullContainer'>
      ...
      <div className='infoInscripciones'>
        ...
        <p>Desde Jardín <em>(4 años)</em> hasta grado Décimo</p>
        <a
          href='https://drive.google.com/drive/folders/1-mDgt3M11XJmcvMJkjGK6EA4g4QRRIB5?usp=drive_link'
          target='_blank'
          rel='noopener noreferrer'
      ...
      {mostrarCircular && (
        <CardInformation
          className='circular'
          imagen={CARD_IMGS.circular.src}
          texto={
            <>
              Ya está disponible la Circular Informativa del mes de{' '}
              <strong>{new Date().toLocaleString('es-ES', { month: 'long' }).toUpperCase()}</strong>, con novedades académicas y administrativas.
            </>
          }
      ...
      {mostrarActividades && (
        <CardSelection
          ...
          imagen={CARD_IMGS.recuperacion.src}
        />
      )}
      ...
      {mostrarHorarios && (
        <CardInformation
          ...
          imagen={CARD_IMGS.horarios.src}
          texto={
            <>
              <em>Nota:</em> Ten en cuenta que el horario de recuperación publicado no incluye algunas asignaturas...
            </>
          }
