  ...
  return (
    <>
      <div className='fullContainer'>
        ...
        <div className='reporteAcademico'>reporte academico</div>
        <div className='recuperacion'>recuperacion</div>
        <div className='actividadesRecuperacion'>actividades recuperacion</div>
      </div>
    </>
  );
};
